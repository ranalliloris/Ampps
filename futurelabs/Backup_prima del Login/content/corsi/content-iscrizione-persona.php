...
<form id="form-iscrizione">
<?php require_once (__DIR__.'/../../inc/info_glob.inc.php');?>
    <p class="text-danger">Il Sistema di prenotazioni sarà attivo dal <?php $data_inizio_iscrizioni?> al <?php $data_fine_iscrizioni?>. 
    </p>
    <div id="dati-utente">
        <div class="row">
            <div class="col-sm-6 mt-2">
                <div class="card">
                    <div class="card-body" id="dati-persona">
                        ...
                        <div class="form-group">
                            <label for="cellulare">cellulare<span class="req">*</span></label>
    ...
    <div id="error-cmdline">
        ...
        <p class="text-center">
            ...
            <a href="" class="btn btn-primary" id="btn-iscriviti">Iscriviti</a>
        </p>
    </div>
