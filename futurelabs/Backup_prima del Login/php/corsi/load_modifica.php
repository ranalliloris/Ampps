<?php
    ...
    $codice_iscrizione=$_POST["codice_iscrizione"];
    try
    {
        
        $dati["datiP"]=datiPersona($dbconn,$codice_iscrizione);
        if($dati["datiP"]==null)
        {
            $dati["esito"]="err_dati";
            $dati["html"]="Codice Iscrizione non trovato nel Database";
        ...
        $corsi=corsiIscrizionePersona($dbconn,$cf);
        $dati["datiC"]=$corsi["corsi"];
        /*
