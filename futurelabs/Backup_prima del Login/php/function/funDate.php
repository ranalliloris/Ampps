   ...
   function inviaMail($to, $subject, $html_msg)
    {
        $mail_boundary = "=_NextPart_" . md5(uniqid(time()));
            ...
            $sender = "postmaster@futurelabsfirenze.it";


            $headers = "From: $sender\n";
            $headers .= "Bcc:postmaster@futurelabsfirenze.it\n";
            ...
            if (mail($to, $subject, $msg, $headers, "-f$sender")) { 
                $str="è stata inviata una mail di conferma al suo indirizzo email";
            } else { 
                $str="<br><br>Recapito e-Mail fallito!";
            }
        return $str;
    }
?>