...
<body onload="onLoadRegistraUtente()">
    
        <?php
        require_once "templates/session.php";
        require_once "templates/header.php";
        require_once "content/esempio/content-registra-utente.php";
        require_once "templates/footer.php";
        ?>   
        <script src="js/event.js?<?php echo filemtime("js/event.js"); ?>"></script>
        <script src="js/registra-utente.js?<?php echo filemtime("js/registra-utente.js"); ?>"></script>
